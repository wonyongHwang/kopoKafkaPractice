...
public class TestGKJoinValues{
    public static void main(String[] args) {
        ...
        mystream.join(chatTable,
                     (mystreamKey, mystreamValue) -> {System.out.println(mystreamKey);System.out.println(mystreamValue); return mystreamValue;},
                     (mystreamValue, chatTableValue) -> {System.out.println(mystreamValue);System.out.println(chatTableValue);return chatTableValue + " at " + mystreamValue;})
                     .to("javatopic");
